          ...
          {new Array(6).fill(0).map((v, index) => {
            return (
              <div key={index} className={styles.serviceBox}>
                <h2 key={v}>Lorem ipsum sincor venetur</h2>
                <p>
                  We can offer pet house visits. If you would like to arrange for one of our vets to make a house call please phone us to talk to the
                  nurses & we will do our best to arrange a mutually suitable consultation time.
                </p>
              </div>
            );
          })}
